<div class="col">
    ...
    <div class="card card-primary">
        ...
        <div class="card-body">
            <button href="#" class="btn btn-success" id="btnCrear" @click.prevent="nuevo()"><i class="fa fa-plus-square-o" aria-hidden="true" ></i> Nueva Incidencia</button>
        </div>
    </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-12 input-group">
                        <label for="cbucategoria" class="col-3 control-label">Seleccione la Categoría : <b style="color: red"> *</b></label>
                        <div class="col-9">
                            <select name="cbucategoria" id="cbucategoria" class="form-control" v-model="newCategoria">
                                ...
                                <option v-for="categoria, key in categorias" v-bind:value="categoria.id">@{{categoria.name}}</option>
                            </select>
                        </div>
                    </div>

                    <div class="col-12 input-group mt-3">
                        <label for="cbuoficina" class="col-3 control-label">Seleccione la Oficina : <b style="color: red"> *</b></label>
                        <div class="col-9">
                            <select name="cbuoficina" id="cbuoficina" class="form-control" v-model="newOficina">
                                ...
                                <option v-for="oficina, key in oficinas" v-bind:value="oficina.id">@{{oficina.oficina}}</option>
                            </select>
                        </div>
                    </div>

                    <div class="col-12 input-group mt-3">
                        <label for="txtmotivo" class="col-3 control-label">Título de la Incidencia: <b style="color: red"> *</b></label>
                        <div class="col-8">
                            <input type="text" class="form-control" id="txtmotivo" name="txtmotivo" placeholder="Ingrese el título de la incidencia." maxlength="512" autofocus v-model="newMotivo">
                        </div>
                    </div>

                    <div class="col-12 input-group mt-3">
                        <label for="txtdetalle" class="col-3 control-label">Detalle de la Incidencia: <b style="color: red"> *</b></label>
                        <div class="col-8">
                            <textarea id="txtdetalle" name="txtdetalle" class="form-control" placeholder="Ingrese a detalle la incidencia." maxlength="1024" v-model="newDetalle"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-12 input-group mt-3">
                        <label for="cbuprioridad" class="col-3 control-label">Prioridad:<b style="color: red"> *</b></label>
                        <div class="col-2">
        ...
        <table class="table table-hover table-bordered table-condensed table-striped" >
            <tbody>
                ...
                <tr v-for="incidencia, key in incidencias">
                    ...
                    <td style="border:1px solid #ddd;"><b>Título: </b>@{{ incidencia.motivo }} <br><b>Detalle: </b>@{{ incidencia.detalle }}</td>
                    <td style="border:1px solid #ddd;">@{{ incidencia.fecincidencia }}</td>
                    <td style="border:1px solid #ddd;">@{{ incidencia.oficina }} <br><p style="font-size: 13px;color: gray;">@{{ incidencia.nombres }}</p></td>
                    ...
                    <td style="border:1px solid #ddd;" style="vertical-align: middle;">
                        <center>
                            <span class="badge text-bg-success" v-if="incidencia.estado=='0'">Pendiente</span>
                            <span class="badge text-bg-warning" v-if="incidencia.estado=='1'">Atendido</span>
                        </center>
                    </td>
                    <td style="border:1px solid #ddd;">
                        <center>
                            <a href="#" class="btn btn-warning m-1" v-on:click.prevent="editIncidencia(incidencia)" data-placement="top" data-toggle="tooltip" title="Solucionar Incidencia."><i class="fa fa-edit"></i></a>
                        </center>
                    </td>
                </tr>
            </tbody>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-12 input-group mt-3">
                            <label for="txtdetalleE" class="col-3 control-label">Solución de la Incidencia: <b style="color: red"> *</b></label>
                            <div class="col-8">
                                <textarea id="txtdetalleE" rows="5" name="txtdetalleE" class="form-control" placeholder="Ingrese la solución a detalle de la incidencia." v-model="fillIncidencias.detalle"></textarea>
                            </div>
                        </div>
