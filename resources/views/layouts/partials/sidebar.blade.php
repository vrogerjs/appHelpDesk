<aside class="main-sidebar sidebar-dark-primary elevation-4" style="font-size: 13px;">
  ...
  <a href="/" class="brand-link text-center">
    <img src="{{asset('img/logo.png')}}" alt="Gobierno Regional de Ancash" class="brand-image img-circle elevation-3" style="float:none;max-height: 100px;">
    <br>
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="image">
        <img src="{{asset('img/user.png')}}" class="img-circle elevation-2" alt="User Image" style="width: 4rem;">
      </div>
      <div class="info">
