<div class="col">
    ...
    <div class="card card-primary">
        ...
        <div class="card-body">
            <button href="#" class="btn btn-success" id="btnCrear" @click.prevent="nuevo()"><i class="fa fa-plus-square-o" aria-hidden="true" ></i> Nueva Categoría</button>
        </div>
    </div>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12 input-group">
                        <label for="txtname" class="col-3 control-label">Categoría: <b style="color: red"> *</b></label>
                        <div class="col-8">
                            <input type="text" class="form-control" id="txtname" name="txtname" placeholder="Ingrese la categoría." maxlength="512" autofocus v-model="newName" >
                        </div>
                    </div>

                    <div class="col-12 input-group mt-3">
                        <label for="txtdescripcion" class="col-3 control-label">Descripción: <b style="color: red"> *</b></label>
                        <div class="col-8">
                            <textarea id="txtdescripcion" name="txtdescripcion" class="form-control" placeholder="Ingrese la descripción." maxlength="1024" v-model="newDescripcion"></textarea>
                        </div>
                    </div>
            ...
            <tbody>
                ...
                <tr v-for="categoria, key in categorias">
                    ...
                    <td style="border:1px solid #ddd;">
                        <center>
                            <a href="#" class="btn btn-success m-1" v-on:click.prevent="asignarResponsable(responsable)" data-placement="top" data-toggle="tooltip" title="Asignar Responsable."><i class="fa fa-users"></i></a>
                            <a href="#" v-if="categoria.activo=='1'" class="btn bg-navy m-1" v-on:click.prevent="baja(categoria)" data-placement="top" data-toggle="tooltip" title="Desactivar Categoría."><i class="fa fa-arrow-circle-down"></i></a>
                            <a href="#" v-if="categoria.activo=='0'" class="btn btn-success m-1" v-on:click.prevent="alta(categoria)" data-placement="top" data-toggle="tooltip" title="Activar Categoría."><i class="fa fa-check-circle"></i></a>
                            <a href="#" class="btn btn-warning m-1" v-on:click.prevent="edit(categoria)" data-placement="top" data-toggle="tooltip" title="Editar Categoría."><i class="fa fa-edit"></i></a>
                            <a href="#" class="btn btn-danger m-1" v-on:click.prevent="borrar(categoria)" data-placement="top" data-toggle="tooltip" title="Borrar Categoría."><i class="fa fa-trash"></i></a>
                        </center>
                    </td>
                </tr>
            </tbody>
